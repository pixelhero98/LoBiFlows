...
Shared utility functions for LoBiFlow.

Consolidates helpers that were duplicated across lob_train_val.py,
experiments_icassp.py, and lob_viz_results.py.
"""
...
__all__ = ["flatten_dict", "unflatten_to_nested", "microstructure_series"]
