...
DEFAULT_CRYPTOS_NPZ = os.path.join(
    _REPO_ROOT,
    "data",
    "cryptos",
    "cryptos_binance_spot_monthly_1s_l10.npz",
)
DEFAULT_ES_MBP_10_NPZ = os.path.join(
    _REPO_ROOT,
    "data",
    "databento",
    "es_mbp_10.npz",
...
class WindowedLOBParamsDataset(torch.utils.data.Dataset):
    ...
    def _build_start_indices(self) -> np.ndarray:
        ...
        if self.segment_ends is None:
            return np.arange(self.H, last_exclusive, self.stride, dtype=np.int64)
