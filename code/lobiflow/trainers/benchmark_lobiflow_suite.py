#!/usr/bin/env python3
"""Tune and benchmark the current LoBiFlow baseline across the main datasets.

This runner implements the confirmed plan:
- datasets: synthetic, optiver, cryptos, es_mbp_10
- use the current winning dataset-specific LoBiFlow defaults
...
def _make_base_args(cli_args: argparse.Namespace, plan: DatasetPlan, history_len: int) -> argparse.Namespace:
    preset = get_lobiflow_dataset_preset(plan.dataset, variant="quality")
