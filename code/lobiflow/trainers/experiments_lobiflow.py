...
from lobiflow.utils.lob_utils import flatten_dict as _flatten
...
try:
    from lobiflow.utils.lob_viz_results import plot_speed_quality, plot_rollout_stability, plot_qualitative
    _HAS_VIZ = True
...
# Runner
# -----------------------------
def run_lobiflow_suite(args: argparse.Namespace):
...
def build_argparser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Run the LoBiFlow experiment suite (A/B/C/D).")
