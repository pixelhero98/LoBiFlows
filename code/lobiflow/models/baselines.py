...
try:
    from lobiflow.models.conditioning import SharedConditioningBackbone
    from lobiflow.models.config import LOBConfig
    from lobiflow.models.modules import MLP, TransformerFUNet, build_mlp
except ImportError:
    from lobiflow.models.conditioning import SharedConditioningBackbone
    from lobiflow.models.config import LOBConfig
    from lobiflow.models.modules import MLP, TransformerFUNet, build_mlp
...
class RectifiedFlowLOB(nn.Module):
    ...
    def _field_forward(
        ...
        cond_state = self.backbone.build_conditioning(hist=hist, x_ref=x_t, t=t, h=step_h, cond=cond)
        if self.fu_net_type == "transformer":
    ...
    def v_forward(
        ...
        return self._field_forward(x_t, t, hist, cond=cond, h=None)
    ...
    def u_forward(
        ...
        return self._field_forward(x_t, t, hist, cond=cond, h=h)
